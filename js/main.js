(function ($) {
    ...
    $('#sofluence_type').parent().append('<ul class="list-item" id="newsofluence_type" name="sofluence_type"></ul>');
    $('#sofluence_type option').each(function(){
        $('#newsofluence_type').append('<li value="' + $(this).val() + '">'+$(this).text()+'</li>');
    });
    $('#sofluence_type').remove();
    $('#newsofluence_type').attr('id', 'sofluence_type');
    $('#sofluence_type li').first().addClass('init');
    $("#sofluence_type").on("click", ".init", function() {
        $(this).closest("#sofluence_type").children('li:not(.init)').toggle('slow');
    });
    ...
    var allOptions = $("#sofluence_type").children('li:not(.init)');
    $("#sofluence_type").on("click", "li:not(.init)", function() {
        allOptions.removeClass('selected');
        $(this).addClass('selected');
        $("#sofluence_type").children('.init').html($(this).html());
